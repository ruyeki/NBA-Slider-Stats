...
def get_player_clutch_totals(active_player_ids, selected_year, position):
    ...
    season = leaguedashplayerclutch.LeagueDashPlayerStats(season=year, player_position_abbreviation_nullable=position)
    season_clutch_regular_season = season.get_data_frames()[0]  # Get the SeasonTotalsRegularSeason dataframe
    season_clutch_active_players = season_totals_regular_season[season_totals_regular_season['PLAYER_ID'].isin(active_player_ids)]
