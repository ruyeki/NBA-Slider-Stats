...
if __name__ == "__main__":
    ...
    selected_players = st.sidebar.multiselect('Select Players', sorted_playersPG['PLAYER_NAME'].unique())

    # Retrieve the stats for the selected players
    selected_players_stats = sorted_playersPG[sorted_playersPG['PLAYER_NAME'].isin(selected_players)]
    ...
    if len(selected_players) > 0:
        ...
        for player_name in selected_players:
            ...
            # Retrieve player image using the NBA API
            ...
            player_row.image(player_image, caption=player_name, use_column_width=True)

            # Display player stats
            player_stats = selected_players_stats[selected_players_stats['PLAYER_NAME'] == player_name]
